...
var itemBuilder = function itemBuilder(no) {
  return {
    id: (0, _uuid.v4)(),
    no: no,
...
var listBuilder = function listBuilder(page) {
  return Array.from({
    length: ITEMS_PER_PAGE
  }).map(function (_, i) {
    return itemBuilder(page * ITEMS_PER_PAGE + i + 1);
  });
};
...
var getRandomSeconds = function getRandomSeconds() {
  return (Math.round(Math.random() * 5) + 1) * 250;
};

var randomTimer = function randomTimer(func) {
...
var dummyFetcher = function dummyFetcher(method, args) {
  return new Promise(randomTimer(method, args));
};
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _util.dummyFetcher)(_listBuilder.default, page);

          case 2:
            list = _context.sent;
            frag = document.createDocumentFragment();
            list.forEach(function (item) {
              return frag.appendChild(renderItem(item));
            });
...
//# sourceMappingURL=/intersectionObserver.e31bb0bc.js.map